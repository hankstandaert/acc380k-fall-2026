...
This Markdown copy is maintained in the course repository so that changes to the syllabus can be tracked over time. Canvas remains the authoritative source for current course requirements, deadlines, and policies.

## Instructor and Teaching Assistant

**Instructor:** Nicholas (Nick) Hallman — [nicholashallman@utexas.edu](mailto:nicholashallman@utexas.edu)  
**Office:** CBA 4M.228  
...
**Teaching Assistant:** Joanna G. Smith — [joanna.smith@utexas.edu](mailto:joanna.smith@utexas.edu)  
...
- **[GitHub](https://github.com/njhallman/acc380k-fall-2026):** The public course repo will hold selected code and materials; Case 2 teams will use private repos. No prior Git or GitHub experience, paid plan, or public student repo is required.
